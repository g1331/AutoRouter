...
- 新增“价格目录”能力：自动拉取模型官方价格（主源 OpenRouter，兜底 LiteLLM），并记录来源、抓取时间、有效状态
...
- 新增“计费管理页（System/Billing）”：提供概览卡片、上游倍率管理、缺失价格修复、近期费用明细表，面向个人开发者和小团队管理员
...
- **外部依赖**
  - OpenRouter Models API（主价格源）
  - LiteLLM price map（兜底价格源）
- **兼容性**
