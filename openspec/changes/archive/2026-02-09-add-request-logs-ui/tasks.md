...
- [x] 4.1 启动后端和前端，手动验证完整流程
  - 访问日志页面 (`http://localhost:3000/en/logs`)
  - 确认数据正确展示（表头、时间、方法、路径、模型、Token、状态码、耗时）
  - 状态码颜色区分正确（200绿色、429黄色、500红色）
  - 测试分页功能（31条数据，2页，Previous/Next按钮正常）
