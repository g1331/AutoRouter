...
- [ ] 3.1 重构上游表单与工作台的模型相关区域，拆分出“模型发现”与“模型规则”两个区块，并展示最近抓取状态、来源标签与规则摘要。
- [ ] 3.2 实现目录浏览与批量导入交互，让管理员能够从原生发现或 LiteLLM 候选目录中选择模型并导入为显式规则。
- [ ] 3.3 补充 hooks、表单组件与工作台组件测试，覆盖状态展示、来源区分、导入回显与规则编辑场景。
