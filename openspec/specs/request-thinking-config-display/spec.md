# request-thinking-config-display Specification

## Purpose
Define how request-side thinking configuration is displayed in the admin request logs list and detail view without mixing it with response-side usage signals.
